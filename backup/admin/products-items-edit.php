<?include("db.php");
	...
	$sql="update tblProducts SET sName='".mysql_real_escape_string($_POST['txtTitle'])."',sContent='".mysql_real_escape_string($_POST['txtContent'])."',
	...
	sContent_PT='".mysql_real_escape_string($_POST['txtContent_PT'])."' where iID='".$_GET['pid']."'";
	@mysql_query($sql,$link);
	$Message="<b><i><font color='red'>Changes Saved!</font></i></b>";
	}
	$sql="select * from tblProducts where iID=".$_GET['pid'];
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<p><b>Manage Products [<?echo $_GET['name'];?> >> <?echo $row['sName'];?>]</b></p>
		<p>Edit Products</p>
		<p><a href="product-photos.php?id=<?echo $_GET['pid'];?>&l=2">
				<img border="0" src="images/manage-photos.jpg" width="120" height="21" alt="Manage Photos"></a></p>
		<p><?echo $Message;?></p>
		<form action="products-items-edit.php?pid=<?echo $_GET['pid'];?>&id=<?echo $_GET['id'];?>&name=<?echo $_GET['name'];?>" method=post>
