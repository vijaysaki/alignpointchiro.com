<?include("db.php");
	...
	$sql="update tblAboutUs SET sName='".mysql_real_escape_string($_POST['txtTitle'])."',sContent='".mysql_real_escape_string($_POST['txtContent'])."',sName_ES='".mysql_real_escape_string($_POST['txtTitle_ES'])."',sContent_ES='".mysql_real_escape_string($_POST['txtContent_ES'])."',sName_PT='".mysql_real_escape_string($_POST['txtTitle_PT'])."',sContent_PT='".mysql_real_escape_string($_POST['txtContent_PT'])."' where iID='".$_GET['id']."'";
	@mysql_query($sql,$link);
	$Message="<b><i><font color='red'>Changes Saved!</font></i></b>";
	}
	$sql="select * from tblAboutUs where iID=".$_GET['id'];
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<p>Edit About Us</p>
		<p><?echo $Message;?></p>
		<form action="about-us-edit.php?id=<?echo $_GET['id'];?>" method=post>
		...
		<table border="0" width="432" cellspacing="4" cellpadding="4" class="ContentText">
			...
			<tr>
				<td width="111" valign="top">Information</td>
				<td width="293" align="left">
				<textarea id="textarea2" rows="9" name="txtContent_ES" cols="34"><?echo $row['sContent_ES']?></textarea>
