<?include("db.php");
	...
	$sql="update tblApplications SET sTitle='".mysql_real_escape_string($_POST['txtTitle'])."',sContent='".mysql_real_escape_string($_POST['txtContent'])."' where iID='".$_GET['id']."'";
	@mysql_query($sql,$link);
	$Message="<b><i><font color='red'>Changes Saved!</font></i></b>";
	}
	$sql="select * from tblApplications where iID=".$_GET['id'];
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<p>Add Services</p>
		<p><?echo $Message;?></p>
		<form action="applications-edit.php?id=<?echo $_GET['id'];?>" method=post>
		<input type=hidden name="action" value="edit">
		<table border="0" width="432" cellspacing="4" cellpadding="4" class="ContentText">
			<tr>
				<td width="111" valign="top">Service Name</td>
				<td width="293"><input type="text" name="txtTitle" size="43" value="<?echo $row['sTitle']?>"></td>
			</tr>
			<tr>
