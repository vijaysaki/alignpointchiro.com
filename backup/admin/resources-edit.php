<?include("db.php");
	...
	$sql="update tblResources SET sName='".mysql_real_escape_string($_POST['txtTitle'])."',sContent='".mysql_real_escape_string($_POST['txtContent'])."',
	...
	$sql="select * from tblResources where iID=".$_GET['id'];
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<p>Edit Resources</p>
		<p><?echo $Message;?></p>
		<form action="resources-edit.php?id=<?echo $_GET['id'];?>" method=post>
