<?include("db.php");
	...
	$sql="update tblSubProducts SET sName='".mysql_real_escape_string($_POST['txtTitle'])."',sContent='".mysql_real_escape_string($_POST['txtContent'])."', sName_ES='".mysql_real_escape_string($_POST['txtTitle_ES'])."',
	sContent_ES='".mysql_real_escape_string($_POST['txtContent_ES'])."', sName_PT='".mysql_real_escape_string($_POST['txtTitle_PT'])."',sContent_PT='".mysql_real_escape_string($_POST['txtContent_PT'])."' where iID='".$_GET['spid']."'";
	@mysql_query($sql,$link);
	$Message="<b><i><font color='red'>Changes Saved!</font></i></b>";
	}
	$sql="select * from tblSubProducts where iID=".$_GET['spid']." order by iOrder";
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<p><a href="product-photos.php?id=<?echo $_GET['spid'];?>&l=3">
				<img border="0" src="images/manage-photos.jpg" width="120" height="21" alt="Manage Photos"></a></p>
		<p>Edit Product</p>
		<p><?echo $Message;?></p>
		<form action="sub-products-edit.php?spid=<?echo $_GET['spid'];?>&pid=<?echo $_GET['pid'];?>&id=<?echo $_GET['id'];?>&name=<?echo $_GET['name'];?>" method=post>
		...
		<table border="0" width="432" cellspacing="4" cellpadding="4" class="ContentText">
			...
			<tr>
				<td width="111" valign="top">Information</td>
				<td width="293" align="left"><textarea id="textarea2" rows="9" name="txtContent_ES" cols="34"><?echo $row['sContent_ES']?></textarea>
