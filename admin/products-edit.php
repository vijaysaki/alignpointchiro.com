<?include("db.php");
	...
	$sql="update tblProductsCat SET sName='".mysql_real_escape_string($_POST['txtTitle'])."',sContent='".mysql_real_escape_string($_POST['txtContent'])."',
	sName_ES='".mysql_real_escape_string($_POST['txtTitle_ES'])."',sContent_ES='".mysql_real_escape_string($_POST['txtContent_ES'])."',
	sName_PT='".mysql_real_escape_string($_POST['txtTitle_PT'])."',sContent_PT='".mysql_real_escape_string($_POST['txtContent_PT'])."' where iID='".$_GET['id']."'";
	@mysql_query($sql,$link);
	$Message="<b><i><font color='red'>Changes Saved!</font></i></b>";
	}
	$sql="select * from tblProductsCat where iID=".$_GET['id'];
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<p><b>Manage Products</b></p>
		<p>Edit Products</p>
		<p><a href="product-photos.php?id=<?echo $_GET['id'];?>&l=1">
				<img border="0" src="images/manage-photos.jpg" width="120" height="21" alt="Manage Photos"></a></p>
		<p><?echo $Message;?></p>
		<form action="products-edit.php?id=<?echo $_GET['id'];?>" method=post>
