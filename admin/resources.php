...
//					echo $key." &nbsp;&nbsp;&nbsp;".$value."<br>";
					...
					else
					{
						$iIdTemp=$value;
						$Checker=0;			
						$sql="update tblResources SET iOrder=".$iOrderTemp." where iID=".$iIdTemp;
						//echo $sql."<br>";
	...
	if($_GET['action']=="delete"){
		$sql="delete from tblResources where iID=".$_GET['id'];
		$result=@mysql_query($sql,$link);
		$Message="<b><i><font color='red'>Item Deleted!</font></i></b>";
	}
	if($_POST['action']=="add"){
	$sql="insert into tblResources (sName,sContent)values('".$_POST['txtTitle']."','".$_POST['txtContent']."')";
	@mysql_query($sql,$link);
	$Message="<b><i><font color='red'>Changes Saved!</font></i></b>";
	}
	$sql="select * from tblResources order by iOrder";
	$result=@mysql_query($sql,$link);
?>
...
<table width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<img border="0" src="images/active-link-manage-resources.jpg" width="197" height="33" alt="Manage Resources"></a><br>
		<br>
		<a href="about-us.php">
		...
		<table border="0" width="432" cellspacing="4" cellpadding="4" class="ContentText">
			<tr>
				<td width="111" valign="top">Resource Name</td>
	...
	<tr>
		...
		<td bgcolor="#444444" width="2" style="height: 2px"><a href="resources-edit.php?id=<?echo $row['iID'];?>">Edit</a></td>
		<td bgcolor="444444" class="LeftLink" style="height: 2px;" align="right" valign="top" colspan="3"><a href="resources.php?action=delete&id=<?echo $row['iID'];?>">Delete</a></td>
